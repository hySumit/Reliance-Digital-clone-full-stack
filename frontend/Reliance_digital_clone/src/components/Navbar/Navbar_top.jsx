      ...
      <div className="nav-main bg-[#E42529] items-center flex justify-between p-5 px-10">
        ...
        <div className="search-bar">
          <input
            ...
            className="rounded-lg w-[400px] h-[35px]"
          />
          <button className=" relative right-5 h-4">
            {" "}
            <IoMdSearch />{" "}
          </button>
        </div>
        ...
        <div className="ul-links text-white  font-bold text-[15px]">
          ...
          <div className="flex gap-2 items-center">
            ...
            <hr className="bg-white h-4 w-px" />
            <Link to={"/cart"} href="#" className="flex items-center">
              {" "}
              <MdShoppingCart />
              Cart
            </Link>
            <hr className="bg-white h-4 w-px" />
            <Link to={"/login"} href="#" className="flex items-center">
              {" "}
              <FaUser />
              Login
            </Link>
